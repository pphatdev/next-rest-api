...
const LeftContentHeader: React.FC<LeftContentHeaderProps> = ({
    ...
    const viewHandle = () => {
        if (view && setView) {
            view === "table" ? setView("grid") : setView("table");
        }
    };
    ...
    return (
        <div className='flex items-center gap-3'>
            ...
            <div className='flex items-center'>
                <Button size={'icon'} variant={'outline'} className='rounded-r-none' onClick={viewHandle}>
                ...
                <Button size={'icon'} variant={'outline'} className='rounded-l-none border-l-0' onClick={viewHandle}>
