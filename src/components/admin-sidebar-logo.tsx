...
const AdminSidebarLogo = () => {
    return (
        <header className='flex h-20 px-5 justify-between gap-2 border-b border-black/10 items-center'>
            ...
            <CollapseButton>
                <svg className='h-8 w-8 text-slate-400' viewBox="0 0 33 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="0.507568" y="0.75" width="32.5" height="32.5" rx="6.25" fill="#F7F8FA"/>
